...
OUTPUT_DIR="${OUTPUT_DIR:-output/fractal_progress_head_vlm_pooled_dit_regression_1k_current_tail_shrink}"
PROGRESS_TARGET="${PROGRESS_TARGET:-current}"
PROGRESS_OUTPUT_TYPE="${PROGRESS_OUTPUT_TYPE:-scalar}"
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-fractal_progress_head_vlm_pooled_dit_regression_1k_current_tail_shrink}"
