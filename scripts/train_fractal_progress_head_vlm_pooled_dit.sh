...
OUTPUT_DIR="${OUTPUT_DIR:-output/fractal_progress_head_vlm_pooled_dit_1k_current}"
PROGRESS_TARGET="${PROGRESS_TARGET:-current}"
RESUME="${RESUME:-0}"
WANDB_PROJECT="${WANDB_PROJECT:-gr00t-progress}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-fractal_progress_head_vlm_pooled_dit_1k_current}"
